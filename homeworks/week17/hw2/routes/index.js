...
router.post(
  "/admin/draw/add-prize",
  checkPermission,
  adminController.handleAddPrize,
  toPreviousPage
);
router.get(
  "/admin/draw/update-prize",
  checkPermission,
  adminController.updatePrize
);
router.post(
  "/admin/draw/update-prize",
  checkPermission,
  adminController.handleUpdatePrize,
  toPreviousPage
);
router.get(
  "/admin/draw/delete-prize",
  checkPermission,
  adminController.deletePrize
);
router.get(
  "/admin/draw/announcement",
  checkPermission,
  adminController.announcement
);
router.post(
  "/admin/draw/announcement",
  checkPermission,
  adminController.handleAnnouncement,
  toPreviousPage
);
